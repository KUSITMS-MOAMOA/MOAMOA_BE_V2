...
public enum ChatErrorStatus implements BaseErrorStatus {
    ...
    INVALID_CHAT_SUMMARY(HttpStatus.INTERNAL_SERVER_ERROR, "E0305_INVALID_CHAT_SUMMARY", "채팅 경험 요약 파싱 중 오류가 발생했습니다."),
    ...
    INVALID_CHAT_RESPONSE(HttpStatus.INTERNAL_SERVER_ERROR, "E0305_INVALID_CHAT_RESPONSE", "채팅 응답 파싱 중 오류가 발생했습니다."),
